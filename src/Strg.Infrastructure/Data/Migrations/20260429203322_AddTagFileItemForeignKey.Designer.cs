...
namespace Strg.Infrastructure.Data.Migrations
{
    ...
    [Migration("20260429203322_AddTagFileItemForeignKey")]
    partial class AddTagFileItemForeignKey
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Strg.Core.Domain.PendingUpload", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "IsCompleted", "ExpiresAt")
            ...
            modelBuilder.Entity("Strg.Core.Domain.Tag", b =>
                {
                    b.HasOne("Strg.Core.Domain.FileItem", null)
                        .WithMany("Tags")
